# 铁路信号机数字孪生监测与可视化分析平台V1.0软件设计说明书

## 1 引言

### 1.1 编写目的

本文档用于对 铁路信号机数字孪生监测与可视化分析平台V1.0 的建设背景、需求分析、总体架构、详细设计、接口设计、运行环境和运维方式进行整理说明，为软件著作权登记、技术归档和后续系统维护提供依据。
...
| src/App.vue | 112 | 应用顶层布局与三类主视图切换入口。 |
...
| src/components/ThreeView.vue | 4164 | Three.js 数字孪生主界面，含信号机模型、列车动画、视频监控和遥测联动。 |
| src/components/DataPanel.vue | 1051 | 大数据可视化总控页面，负责顶部信息、全局告警和左右中子面板联动。 |
| src/components/datapanel/LeftPanel.vue | 726 | 左侧环境与传感器状态面板。 |
| src/components/datapanel/CenterPanel.vue | 1631 | 中部调度总览、寿命预测和线路态势面板。 |
| src/components/datapanel/RightPanel.vue | 1463 | 右侧设备统计、告警列表和运维概览面板。 |
...
| --- | --- |
| 1 | getWorldYaw |
| 2 | createSignalRuntime |
| 3 | getSignalRuntime |
| 4 | getSignalStatusMeta |
| 5 | getVoltageAlertItems |
| 6 | buildModalSeriesValue |
| 7 | syncSignalTwin |
| 8 | openDeviceModal |
| 9 | closeDeviceModal |
| 10 | speakAlarm |
| 11 | applyLabelBoxTone |
| 12 | restoreNormalState |
| 13 | setPedestrianVisible |
| 14 | triggerPedestrianHotFlash |
| 15 | applyTwinEnvVisibilityToLabels |
| 16 | handleSignalAction |
| 17 | onGlobalKeydown |
| 18 | updateTelemetrySim |
| 19 | stopFrontendTelemetrySim |
| 20 | startFrontendTelemetrySim |
| 21 | scheduleNextPass |
| 22 | runPass |
| 23 | jitterDistance |
| 24 | onParamChange |
| 25 | onParamTimeChange |
| 26 | STREAM_URL |
| 27 | logVideo |
| 28 | buildStreamUrl |
| 29 | loadVideo |
| 30 | onVideoLoad |
| 31 | reloadVideo |
| 32 | playPedestrianNotice |
| 33 | ensureGltfLoader |
| 34 | getCachedModelClone |
| 35 | createRadialGlowTexture |
| 36 | createSkyParticles |
| 37 | createRailEndpointGlows |
| 38 | makeGlow |
| 39 | getClosestPathProgress |
| 40 | getColorByState |
| 41 | init |
| 42 | setupLights |
| 43 | createAxisHelper |
...
| 46 | createMountains |
| 47 | createRailway |
| 48 | createSignalLights |
| 49 | getObjectSize |
| 50 | placeOnGround |
| 51 | createBoxSensorLabel |
| 52 | createSensorWave |
| 53 | loadAndPlaceNear |
| 54 | createTrain |
| 55 | createModelLabel |
| 56 | updateLabelFields |
| 57 | toTrainGps |
| 58 | getPedestrianDistanceMeters |
| 59 | updateHumanoidSensorPanel |
| 60 | updateBoxSensorLabel |
| 61 | startAutoDemo |
| 62 | createTrees |
| 63 | updateSignalUI |
| 64 | toggleSignals |
...
| 4 | heroDeviceName |
| 5 | uiNowMs |
| 6 | signalRuntimeState |
| 7 | signalFaultSignalId |
| 8 | telemetryConnected |
| 9 | signalHardwareReady |
| 10 | signalFaultActive |
| 11 | selectedSignalFaultActive |
| 12 | trackFaultActive |
| 13 | observedTrackCapacitance |
| 14 | deviceModal |
| 15 | latestVoiceText |
| 16 | signalParams |
| 17 | humidityClass |
| 18 | signalTwin |
| 19 | telemetryDistanceM |
| 20 | telemetryWaterActive |
| 21 | pedestrianDesiredVisible |
| 22 | pedestrianHotFlash |
| 23 | telemetrySimEnabled |
| 24 | telemetrySimLastAt |
| 25 | telemetryActive |
| 26 | twinEnvVisible |
| 27 | telemetryStatusText |
| 28 | telemetryStatusClass |
| 29 | telemetryLastSeenText |
| 30 | telemetryWaterText |
| 31 | telemetryWaterClass |
| 32 | installStatusText |
| 33 | installStatusClass |
| 34 | activeSignalState |
| 35 | currentSignalFaultName |
| 36 | activeSignalStateText |
| 37 | activeSignalStateClass |
| 38 | alertFeed |
| 39 | deviceStatusRows |
| 40 | panelTimeText |
| 41 | modalSignalId |
| 42 | modalSignalName |
| 43 | modalTypeText |
| 44 | modalDataSignalId |
| 45 | modalConnectedAt |
| 46 | modalHasRealtimeData |
| 47 | modalCurrentMetric |
| 48 | modalMetricUnit |
| 49 | modalYAxisTitle |
| 50 | modalXAxisTitle |
| 51 | modalAlertText |
...
| 56 | modalAreaPoints |
| 57 | modalYAxisTicks |
| 58 | modalPreviewStats |
| 59 | selectedParam |
| 60 | paramTimeRange |
| 61 | hoveredParamPoint |
| 62 | paramConfig |
| 63 | currentParamValue |
| 64 | paramData1h |
| 65 | paramData24h |
| 66 | paramDataWeek |
| 67 | currentParamData |
...
| 13 | humidityAlertPayload |
| 14 | humidityStage |
| 15 | humidityAlertClass |
| 16 | humidityAlertChartPoints |
| 17 | humidityAlertLinePoints |
| 18 | humidityAlertAreaPoints |
| 19 | humidityAlertLabelPoints |
...
| 19 | alarmCount |
| 20 | filteredAlarms |
| 21 | deviceDialogCharts |
| 22 | deviceDialogStats |
| 23 | deviceDialogNote |
| 24 | securityColor |
| 25 | pieSlices |
